(function(){
  ...
  qx.$$loader = {
    parts : {"boot":[0]},
    packages : {"0":{"uris":["__out__:wialon.7f2c3a0dc7ec.js"]}},
    urisBefore : [],
    cssBefore : [],
    boot : "boot",
    closureParts : {},
  ...
  (function(){
    ...
    var a = "unit/update_sensor",b = "resource/update_poi",c = "resourceZoneGroups",d = "unitSensors",f = "adminField",g = "itemProfileFields",h = "resource/update_drivers_group",l = "render",m = "u",n = "order/update",o = "zonesGroup",p = "item/delete_item",q = "singleton",r = "resourcePois",s = "ftp",t = "item/update_admin_field",u = "&svc=file/get&params=",v = "script",w = "avl_evts:request",x = "core/check_items_billing",y = "resource/get_job_data",z = "qx.event.type.Event",A = "//",B = "item/update_profile_field",C = "resource/get_poi_data",D = "ujb",E = "token/login",F = "token/update",G = "file/list",H = "//geocode-maps.wialon.com/",I = "report",J = "unitFuelSettings",K = "local",L = "route/get_round_data",M = "tags",N = "flds",O = "core/get_hw_types",P = "userNotification",Q = "si",R = "order_routes",S = "core/search_item",T = "profileField",U = "=",V = 'u',W = "core/create_resource",X = "core/create_user",Y = "?sid=",fd = "number",eY = "firmware",fe = "customField",fa = "core/create_unit",fb = "; ",eW = "usnf",fc = "unitCommandDefinitions",fj = "resource/update_tag",fk = "token/list",fq = "routeSchedules",fl = "core/login",ff = "route/update_round",fg = "string",fh = "//routing-maps.wialon.com/",fi = "core/create_auth_hash",fp = "__dd",fT = "poi",fr = "ud",fs = "core/update_data_flags",fm = "serviceInterval",fn = "core/create_retranslator",gU = "resourceReports",fo = "core/reset_password_perform",ft = "core/create_route",fu = "unitReportSettings",fv = "sensor",fA = "qx.event.type.Data",fB = "search",fC = "//search-maps.wialon.com/",fw = "resource/update_zone",fx = "/avl_evts",fy = "rr",fz = "round",fH = "zone",fI = "core/create_unit_group",fJ = "unf",fK = "item/update_ftp_property",fD = "aflds",fE = "mapps",fF = "serverUpdated",fG = "core/get_account_data",fO = "//render-maps.wialon.com/",fP = "fileUploaded",he = "avl_evts",fQ = "resourceDrivers",fL = "commandDefinition",fM = "unitServiceIntervals",hc = "resource/update_zones_group",fN = "function",fR = "tagsgr",fS = "rep",gf = "report/update_report",ge = "resource/update_job",gd = "rs",gj = "zl",gi = "wialon.js",gh = "en",gg = "itemCreated",fX = "unitEventRegistrar",fW = "orders",fV = 'undefined',fU = "user/update_user_notification",gc = "[\\?&]callback=([^&#]*)",gb = "d",ga = "geocode",fY = "trlrs",gq = "user/send_sms",gp = "core/get_hw_cmds",go = "file/read",gn = "route/update_schedule",gu = "account/get_account_data",gt = "/wialon/ajax.html",gs = "lang",gr = "m",gm = "resource/update_trailers_group",gl = "report/get_report_tables",gk = "resourceAccounts",gF = "resourceTags",gE = "trailer",gD = "account/list_change_accounts",gJ = "notification",gI = "unit/update_command_definition",gH = "itemIcon",gG = "order/route_update",gy = "schedule",gx = "col",gw = "drvrs",gv = "1.51",gC = "file/library",gB = "statsFinished",gA = "itemFtpProps",gz = "__dc",gP = "core/search_items",gO = "core/duplicate",gN = "trlrsgr",gM = "FtpProp",gT = "trailersGroup",gS = "mobileApp",gR = "object",gQ = "sensu",gL = "resource/update_notification",gK = "unitDriveRankSettings",eo = "tag",en = "__cY",hf = "orderRoute",el = "wialon.core.Session",em = "featuresUpdated",ek = "item/update_custom_field",hd = "unit/update_service_interval",ei = "invalidSession",ej = "drvrsgr",eh = "resourceJobs",ha = "core/use_auth_hash",ef = "resourceTrailers",eg = "routeRounds",ee = "resourceTrailerGroups",ex = "core/logout",ey = "driversGroup",ev = "__cV",ew = "core/set_session_property",et = "resourceNotifications",eu = "resource/update_tags_group",es = "order",ed = "job",eq = "resource/update_trailer",er = "core/check_accessors",ep = "core/reset_password_request",eL = "resource/get_notification_data",eJ = "itemAdminFields",eK = "report/get_report_data",eH = "unitMessagesFilter",eI = "cml",eG = "/",gY = "&svc=core/export_file&params=",eE = "tagsGroup",eF = "unitTripDetector",eD = "itemDeleted",hb = "",eB = "resource/get_zone_data",eC = "resourceZones",ez = "mobileApps",eA = "userNotifications",eT = "resourceOrders",eU = "sens",eR = "Can't parse avl_evts json, possible wrong chars in responce. Data is ignored.",eS = "resource/update_driver",eP = "driver",eQ = "itemCustomFields",eO = "unitEvents",gW = "routing",eM = "resourceDriverGroups",eN = "pflds",eV = "user/update_mobile_app",gV = "undefined",eX = "zg";
    qx.Class.define(el, {
      extend : qx.core.Object,
      type : q,
      construct : function(){
      ...
      members : {
        ...
        __wH : null,
        __wJ : null,
        initSession : function(hi, hh, hg, hl, hj, hm){
          ...
          this.__de = hi;
          this.__wD = hi;
          if(typeof hh != gV)this.__dg = hh;
          if(typeof hg != gV && !isNaN(parseInt(hg))){
  
            var hk = parseInt(hg);
            if(hk & 0x800)this.__df = true;
          };
          if(typeof hl != gV)this.__di = hl;
          ...
          if(hm){
            ...
            if(hm.apiPath)this.__wE = hm.apiPath;
            if(hm.gisUrl)this.__wD = hm.gisUrl;
            this.__wF = !!hm.ignoreBaseUrl;
            this.__wG = !!hm.whiteLabel;
            this.__wH = hm.logger;
            this.__wJ = hm.loginSiteName;
          };
          return true;
        },
        ...
        login : function(hr, hp, hq, ho){
          ...
          return wialon.core.Remote.getInstance().remoteCall(fl, {
            user : hr,
            password : hp,
            operateAs : hq,
            loginHash : this.__dh,
          ...
          }, qx.lang.Function.bind(this.__dw, this, ho));
        },
        loginAuthHash : function(hw, hv, ht){
  
          var hs = hb;
          if(hv && typeof hv == fN)ht = hv; else if(hv && typeof hv == fg)hs = hv;;
          ...
          if(this.__wJ)hu.siteName = this.__wJ;
          return wialon.core.Remote.getInstance().remoteCall(ha, hu, qx.lang.Function.bind(this.__dw, this, ht));
        },
        loginToken : function(hz, hB, hy){
  
          var hx = hb;
          if(hB && typeof hB == fN)hy = hB; else if(hB && typeof hB == fg)hx = hB;;
          ...
          if(this.__wJ)hA.siteName = this.__wJ;
          return wialon.core.Remote.getInstance().remoteCall(E, hA, qx.lang.Function.bind(this.__dw, this, hy));
        },
        duplicate : function(hH, hE, hC, hG, hD){
          ...
          return wialon.core.Remote.getInstance().remoteCall(gO, {
            operateAs : hE,
            continueCurrentSession : hC,
            checkService : this.__di,
            restore : hF,
            appName : this.__dg
          }, qx.lang.Function.bind(this.__dw, this, hG));
        },
        logout : function(hI){
          ...
          return wialon.core.Remote.getInstance().remoteCall(ex, null, qx.lang.Function.bind(function(hJ, hK){
        ...
        updateSessionProperty : function(hN, hM){
  
          return wialon.core.Remote.getInstance().remoteCall(ew, {
            prop_name : hN.propName,
            prop_value : hN.propValue
          }, wialon.util.Helper.wrapCallback(hM));
        },
        updateToken : function(hO, hP, hQ){
          ...
          return wialon.core.Remote.getInstance().remoteCall(F, {
            ...
            p : hP.p,
            items : hP.items,
            deleteAll : hP.deleteAll,
            userId : hP.userId
          }, hQ);
        },
        listTokens : function(hS, hR){
  
          return wialon.core.Remote.getInstance().remoteCall(fk, {
            app : hS.app,
            userId : hS.userId
          }, wialon.util.Helper.wrapCallback(hR));
        },
        updateDataFlags : function(hU, hT){
  
          hT = wialon.util.Helper.wrapCallback(hT);
          if(!this.__cV || typeof hU != gR){
          ...
          return wialon.core.Remote.getInstance().remoteCall(fs, {
            spec : hU
          }, qx.lang.Function.bind(this.__dx, this, hT));
        },
        searchItems : function(ia, hY, hV, hX, hW, ib, ic){
  
          ib = wialon.util.Helper.wrapCallback(ib);
          if(!this.__cV || typeof ia != gR){
          ...
          return wialon.core.Remote.getInstance().remoteCall(gP, {
            ...
            from : hX,
            to : hW
          }, qx.lang.Function.bind(this.__dy, this, ib), ic);
        },
        searchItem : function(ih, ie, ig){
          ...
          return wialon.core.Remote.getInstance().remoteCall(S, {
            id : ih,
            flags : ie
          }, qx.lang.Function.bind(this.__dz, this, ig));
        },
        loadLibrary : function(ii){
  
          if(typeof this._libraries[ii] != gV)return true;
          if(ii == eA)wialon.item.PluginsManager.bindPropItem(wialon.item.User, eW, P, fU); else if(ii == eQ)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, N, fe, ek); else if(ii == gA)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, s, gM, fK); else if(ii == eJ)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, fD, f, t); else if(ii == g)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, eN, T, B); else if(ii == gH){
  
            qx.Class.include(wialon.item.Unit, wialon.item.MIcon);
            qx.Class.include(wialon.item.UnitGroup, wialon.item.MIcon);
          } else if(ii == fc)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, eI, fL, gI); else if(ii == d){
  
            wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, eU, fv, a);
            qx.Class.include(wialon.item.Unit, wialon.item.MUnitSensor);
          } else if(ii == fM)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, Q, fm, hd); else if(ii == eF)qx.Class.include(wialon.item.Unit, wialon.item.MUnitTripDetector); else if(ii == eH)qx.Class.include(wialon.item.Unit, wialon.item.MUnitMessagesFilter); else if(ii == fX)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEventRegistrar); else if(ii == fu)qx.Class.include(wialon.item.Unit, wialon.item.MUnitReportSettings); else if(ii == gK)qx.Class.include(wialon.item.Unit, wialon.item.MUnitDriveRankSettings); else if(ii == J)qx.Class.include(wialon.item.Unit, wialon.item.MUnitFuelSettings); else if(ii == et)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fJ, gJ, gL, eL); else if(ii == eh)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, D, ed, ge, y); else if(ii == eC){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MZone);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gj, fH, fw, eB);
          } else if(ii == c){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MZone);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, eX, o, hc);
          } else if(ii == r){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MPoi);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fT, fT, b, C);
          } else if(ii == fQ){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
            wialon.item.MDriver.registerDriverProperties();
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gw, eP, eS);
          } else if(ii == eM){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
            wialon.item.MDriver.registerDriverProperties();
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, ej, ey, h);
          } else if(ii == ef){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
            wialon.item.MDriver.registerDriverProperties();
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fY, gE, eq);
          } else if(ii == ee){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
            wialon.item.MDriver.registerDriverProperties();
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gN, gT, gm);
          } else if(ii == gk)qx.Class.include(wialon.item.Resource, wialon.item.MAccount); else if(ii == gU){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MReport);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fS, I, gf, eK);
          } else if(ii == eg)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, fy, fz, ff, L); else if(ii == fq)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, gd, gy, gn); else if(ii == eO)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEvents); else if(ii == ez)wialon.item.PluginsManager.bindPropItem(wialon.item.User, fE, gS, eV); else if(ii == eT){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MOrder);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fW, es, n);
            qx.Class.include(wialon.item.Resource, wialon.item.MOrderRoute);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, R, hf, gG);
          } else if(ii == gF){
  
            qx.Class.include(wialon.item.Resource, wialon.item.MTag);
            wialon.item.MTag.registerTagProperties();
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, M, eo, fj);
            wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fR, eE, eu);
          } else return false;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
          this._libraries[ii] = 1;
          return true;
        },
        getHwTypes : function(ik, ij){
  
          var il = {
          };
          if(ik && typeof ik == fN)ij = ik; else if(ik && typeof ik == gR)il = ik;;
          if(!this.__cV){
          ...
          return wialon.core.Remote.getInstance().remoteCall(O, {
            filterType : il.filterType,
            filterValue : il.filterValue,
            includeType : il.includeType
          }, wialon.util.Helper.wrapCallback(ij));
        },
        getHwCommands : function(im, io, ip){
        ...
        getHwCommandTemplates : function(is, iq){
          ...
          if(is && typeof is == gR){
            ...
            ir.deviceTypeId = arguments[0];
            ir.unitId = arguments[1];
            ir.lang = gh;
            iq = wialon.util.Helper.wrapCallback(arguments[2]);
          };
          if(!this.__cV){
          ...
          return wialon.core.Remote.getInstance().remoteCall(gp, {
            deviceTypeId : ir.deviceTypeId,
            unitId : ir.unitId,
            template : 1,
            lang : ir.lang
          }, iq);
        },
        createUnit : function(iw, name, iu, it, iv){
          ...
          return wialon.core.Remote.getInstance().remoteCall(fa, {
            creatorId : iw.getId(),
            name : name,
            hwTypeId : iu,
            dataFlags : it
          }, qx.lang.Function.bind(this.__dz, this, iv));
        },
        createUser : function(iA, name, iz, ix, iy){
          ...
          return wialon.core.Remote.getInstance().remoteCall(X, {
            ...
            password : iz,
            dataFlags : ix
          }, qx.lang.Function.bind(this.__dz, this, iy));
        },
        createUnitGroup : function(iD, name, iB, iC){
          ...
          return wialon.core.Remote.getInstance().remoteCall(fI, {
            ...
            name : name,
            dataFlags : iB
          }, qx.lang.Function.bind(this.__dz, this, iC));
        },
        createRetranslator : function(iH, name, iG, iE, iF){
          ...
          return wialon.core.Remote.getInstance().remoteCall(fn, {
            ...
            config : iG,
            dataFlags : iE
          }, qx.lang.Function.bind(this.__dz, this, iF));
        },
        createRoute : function(iK, name, iI, iJ){
  
          iJ = wialon.util.Helper.wrapCallback(iJ);
          if(!this.__cV){
          ...
          return wialon.core.Remote.getInstance().remoteCall(ft, {
            ...
            name : name,
            dataFlags : iI
          }, qx.lang.Function.bind(this.__dz, this, iJ));
        },
        createResource : function(iO, name, iL, iN, iM){
          ...
          return wialon.core.Remote.getInstance().remoteCall(W, {
            ...
            skipCreatorCheck : iN,
            dataFlags : iL
          }, qx.lang.Function.bind(this.__dz, this, iM));
        },
        deleteItem : function(iP, iQ){
  
          iQ = wialon.util.Helper.wrapCallback(iQ);
          return wialon.core.Remote.getInstance().remoteCall(p, {
            itemId : iP.getId()
          }, qx.lang.Function.bind(this.__dA, this, iQ, iP.getId()));
        },
        updateItem : function(iS, iT){
          ...
          if(iT.tp === fr){
            ...
            if(iT.pos){
              ...
              if(typeof iT.pos.t === gV)iT.pos.t = iT.t;
              if(typeof iT.pos.f === gV)iT.pos.f = iT.f;
              if(typeof iT.pos.lc === gV)iT.pos.lc = iT.lc;
            };
          };
          for(var iR in iT){
  
            switch(iR){case eU:case gQ:
            continue;};
            iU.call(this, iR);
          };
          if(Object.prototype.hasOwnProperty.call(iT, eU))iU.call(this, eU);
          if(Object.prototype.hasOwnProperty.call(iT, gQ))iU.call(this, gQ);
          function iU(iV){
        ...
        getIconsLibrary : function(iX, ja, jb){
  
          var iY = 0;
          if(typeof jb != gV)iY = ja; else jb = ja;
          wialon.core.Remote.getInstance().remoteCall(gC, {
            type : iX,
            flags : iY
          }, wialon.util.Helper.wrapCallback(jb));
        },
        getFirmwareLibrary : function(jd, jc){
          ...
          wialon.core.Remote.getInstance().remoteCall(G, {
            ...
            recursive : true,
            fullPath : true
          }, wialon.util.Helper.wrapCallback(jc));
        },
        getLibraryFile : function(je){
          ...
          return wialon.core.Session.getInstance().getBaseUrl() + this.__wE + Y + wialon.core.Session.getInstance().getId() + u + wialon.util.Json.stringify(jf);
        },
        readLibraryFile : function(jg, jh){
  
          wialon.core.Remote.getInstance().remoteCall(go, {
            itemId : 0,
            storageType : 1,
            path : jg
          }, wialon.util.Helper.wrapCallback(jh));
        },
        resetPasswordRequest : function(jp, jo, jl, jn, jk){
          ...
          var jj = document.cookie.split(fb);
          var ji = gh;
          for(var i = 0;i < jj.length;i++){
  
            var jm = jj[i].split(U);
            if(jm.length == 2 && jm[0] == gs){
        ...
        resetPasswordPerform : function(js, jr, jq){
  
          jq = wialon.util.Helper.wrapCallback(jq);
          if(!this.__cS){
        ...
        getAccountsData : function(jz, jA, jy){
          ...
          return wialon.core.Remote.getInstance().remoteCall(gu, {
            itemId : jz,
            type : jA
          }, wialon.util.Helper.wrapCallback(jy));
        },
        checkItemsBilling : function(jB, jC, jD, jE){
        ...
        checkAccessors : function(jG, jF){
  
          return wialon.core.Remote.getInstance().remoteCall(er, jG, wialon.util.Helper.wrapCallback(jF));
        },
        listChangeAccount : function(jI, jH){
  
          return wialon.core.Remote.getInstance().remoteCall(gD, {
            dataFlags : jI.dataFlags,
            units : jI.units
          }, wialon.util.Helper.wrapCallback(jH));
        },
        getReportTables : function(jJ){
  
          return wialon.core.Remote.getInstance().remoteCall(gl, {
          }, wialon.util.Helper.wrapCallback(jJ));
        },
        setLoginHash : function(jK){
  
          this.__dh = jK;
        },
        getExportListUrl : function(jM){
  
          var jL = qx.lang.Object.clone(jM);
          return wialon.core.Session.getInstance().getBaseUrl() + this.__wE + Y + wialon.core.Session.getInstance().getId() + gY + encodeURIComponent(wialon.util.Json.stringify(jL));
        },
        ...
        getItem : function(jN){
          ...
          var jO = this.__cY[parseInt(jN)];
          if(typeof jO != fV)return jO;
          return null;
        },
        getItems : function(jR){
  
          if(!this.__cY || !this.__da)return null;
          if(typeof jR == gV || jR == hb){
  
            var jQ = new Array;
            for(var jP in this.__cY)jQ.push(this.__cY[jP]);
            return jQ;
          } else {
  
            var jS = this.__da[jR];
            if(typeof jS != gV)return jS;
          };
          return (new Array);
        },
        registerConstructor : function(jT, jU){
  
          if(typeof this.__cR[jT] != gV)return;
          this.__cR[jT] = jU;
        },
        registerProperty : function(jV, jW){
  
          if(typeof this.__cQ[jV] != gV)return;
          this.__cQ[jV] = jW;
        },
        getBaseUrl : function(){
        ...
        setEvtPollInterval : function(jY){
          ...
          if(this.__cU !== jY){
            ...
            if(this.__wx){
              ...
              if(kb >= jY * 1000){
                ...
                var ka = jY * 1000 - kb;
                if(ka < 0)ka = 0;
                this.__wx = qx.lang.Function.delay(this.__dq, ka, this);
              };
            };
          };
        },
        getBaseGisUrl : function(kc){
  
          if(!this.__df && this.__wD != hb){
  
            var kd = this.__wD.split(A);
            if(kd.length >= 2){
  
              if(kc == l)return kd[0] + fO + kd[1]; else if(kc == fB)return kd[0] + fC + kd[1]; else if(kc == ga)return kd[0] + H + kd[1]; else if(kc == gW)return kd[0] + fh + kd[1];;;;
            };
          };
          return this.__wD;
        },
        ...
        checkFeature : function(ke){
  
          if(!this.__dk || typeof this.__dk.svcs == gV)return 0;
          if(typeof this.__dk.svcs[ke] == gV){
  
            if(this.__dk.unlim == 1)return 1;
            return 0;
          };
          var kf = this.__dk.svcs[ke];
          if(kf == 1)return 1; else if(kf == 0)return -1;;
          return 0;
        },
        __dq : function(){
          ...
          this.__wx = null;
          this.__wy = Date.now();
          if(!this.__cT || !this.__cU || typeof wialon === gV)return;
          if(this.__wH && (typeof this.__wH.info === fN)){
          ...
          wialon.core.Remote.getInstance().ajaxRequest(fx, {
            sid : this.__cT
          }, qx.lang.Function.bind(this.__dr, this, this.__cT), 60);
        },
        __dr : function(km, kh, kl){
          ...
          if(kh != 0){
            ...
            if(kh == 1){
              ...
              if(this.__ds(km))this.fireEvent(ei);
            } else if(this.__cU){
          ...
          this.__cW = kl.tm;
          for(var i = 0;i < kl.events.length;i++){
  
            var kn = kl.events[i];
            if(kn.i > 0){
  
              var kk = this.getItem(kn.i);
              if(kk && typeof kk != gV){
  
                if(kn.t == m)this.updateItem(kk, kn.d); else if(kn.t == gr)kk.handleMessage(kn.d); else if(kn.t == gb)this._onItemDeleted(kk);;;
              } else {
  
                if(kn && (typeof kn.i === fd) && (kn.t === V)){
  
                  var kj = this.__dj[kn.i];
                  if(!kj){
            ...
            } else if(kn.i == -1)this.fireDataEvent(fP, kn.d, null); else if(kn.i == -2){
              ...
              this.fireDataEvent(gB, kn.d, null);
            } else if(kn.i == -5){
  
              var ko = kn.d;
              if(typeof ko.r != gV && ko.r.length){
  
                for(var j = 0;j < ko.r.length;j++){
  
                  var kk = this.getItem(ko.r[j]);
                  if(kk)this._onItemDeleted(kk);
                };
              };
              if(typeof ko.a != gV && ko.a.length){
  
                var ki = [];
                for(var j = 0;j < ko.a.length;j++){
  
                  var kp = ko.a[j].ids;
                  for(var k = 0;k < kp.length;k++){
  
                    var kg = kp[k];
                    var kk = this.getItem(kg);
                    if(!kk)ki.push(kg);
                  };
                };
                if(ki.length){
        ...
        checkNewItems : function(kt, kq){
  
          var ku = kt.ids,kr = kt.updateDataFlagsSpec;
          var ks = wialon.core.Session.getInstance();
          ku = ku.filter(qx.lang.Function.bind(function(kv){
  
            if(this.__wA[kv])return false;
            if(this.getItem(kv))return false;
            this.__wA[kv] = true;
            return true;
          }, this));
          if(!kr){
          ...
          this.updateDataFlags(kr, qx.lang.Function.bind(function(kx){
  
            ku.forEach(qx.lang.Function.bind(function(ky){
  
              delete this.__wA[ky];
            }, this));
            if(kx){
  
              if(typeof kq === fN)kq(kx);
              return;
            };
            var kw = [];
            ku.forEach(qx.lang.Function.bind(function(kA){
  
              var kz = this.getItem(kA);
              if(!kz)return;
              kw.push(kz);
            }, this));
            this.fireDataEvent(gg, kw, null);
            if(typeof kq === fN)kq(null);
          }, this));
        },
        parseSessionData : function(kC){
  
          if(!kC || this.__cV)return false;
          this.__cT = kC.eid;
          this.__cU = 2;
          this.__cW = kC.tm;
          this.__db = kC.au;
          this.__fE = (kC.api && kC.api.indexOf(K) >= 0) ? 1 : 0;
          if(kC.wsdk_version)this.__dn = kC.wsdk_version;
          if(kC.hl)this.__dp = kC.hl;
          this.__cX = {
          };
          for(var kB in kC.classes)this.__cX[kC.classes[kB]] = kB;
          this.__cY = {
          };
          this.__da = {
          };
          this.__cV = this.__dt(kC.user, wialon.item.User.defaultDataFlags());
          this.__du(this.__cV);
          if(kC.token){
  
            try{
  
              this.__do = wialon.util.Json.parse(kC.token);
              if(kC.th)this.__do.th = kC.th;
          ...
          if(typeof kC.features != gV)this.__dk = kC.features;
          if(typeof kC.base_url != gV && kC.base_url != hb && kC.base_url != this.getBaseUrl()){
  
            this.__wD = kC.base_url;
            if(!this.__wF){
  
              this.setBaseUrl(kC.base_url);
            };
          };
          this.__wu = kC.hw_gw_ip || hb;
          this.__wK = kC.hw_gw_dns || hb;
          if(typeof kC.env != gV && kC.env)this.__wB = kC.env;
          if(this.__cU){
        ...
        __ds : function(kD){
          ...
          if(kD && kD != this.__cT)return false;
          this.__cS = 0;
          this.__cT = hb;
          this.__cV = null;
          this.__cW;
        ...
        __dt : function(kH, kG){
          ...
          if(!kH || !kG)return null;
          kH.tp = this.__cX[kH.cls];
          if(typeof kH.tp == gV)return null;
          var kF;
          var kI = this.__cR[kH.tp];
          if(typeof kI == gV)return null;
          kF = new kI(kH, kG);
          this.updateItem(kF, kH);
          var kE = kF && this.__dj[kF.getId()];
          if(kE){
  
            delete this.__dj[kF.getId()];
            kE.forEach(qx.lang.Function.bind(function(kJ){
  
              this.updateItem(kF, kJ.d);
            }, this));
          };
          return kF;
        },
        __du : function(kK){
          ...
          if(!kK || !this.__cY)return;
          this.__cY[kK.getId()] = kK;
          var kL = this.__da[kK.getType()];
          if(typeof kL == gV){
  
            this.__da[kK.getType()] = new Array;
            kL = this.__da[kK.getType()];
          };
          kL.push(kK);
        },
        __dv : function(kM){
          ...
          if(!kM)return;
          if(typeof this.__cY[kM.getId()] != gV)delete this.__cY[kM.getId()];
          var kN = this.__da[kM.getType()];
          if(typeof kN != gV)qx.lang.Array.remove(kN, kM);
          kM.dispose();
        },
        _onItemDeleted : function(kO){
  
          if(!kO)return;
          kO.fireEvent(eD);
          this.__dv(kO);
        },
        __dw : function(kP, kQ, kR){
          ...
          if(this.parseSessionData(kR))kP(0); else kP(6);
        },
        __dx : function(kV, kT, kY){
          ...
          for(var i = 0;i < kY.length;i++){
            ...
            var kU = kY[i].d;
            var kX = this.__cY[kS];
            if(typeof kX == gV && kW != 0 && kU){
  
              var kX = this.__dt(kU, kW);
              if(kX)this.__du(kX);
            } else {
  
              if(kW == 0)this.__dv(kX); else {
  
                if(typeof kX == gV)return;
                if(kU)this.updateItem(kX, kU);
                kX.setDataFlags(kW);
              };
            };
            kU = null;
        ...
        __dy : function(lb, la, le){
          ...
          var lc = {
            searchSpec : le.searchSpec,
            dataFlags : le.dataFlags,
            totalItemsCount : le.totalItemsCount,
            indexFrom : le.indexFrom,
            indexTo : le.indexTo,
            items : []
          };
          for(var i = 0;i < le.items.length;i++){
  
            var ld = this.__dt(le.items[i], le.dataFlags);
            if(ld)lc.items.push(ld);
            qx.core.ObjectRegistry.unregister(ld);
          };
          lb(0, lc);
          return lc;
        },
        __dz : function(li, lg, lh){
          ...
          var lf = this.__dt(lh.item, lh.flags);
          qx.core.ObjectRegistry.unregister(lf);
          li((lf === null ? 6 : 0), lf);
          return lf;
        },
        __dA : function(lk, lj, ll){
  
          if(!ll){
  
            var lm = this.getItem(lj);
            if(lm){
    ...
    var gX = window.setInterval(function(){
  
      if(qx.$$loader.scriptLoaded){
  
        clearInterval(gX);
        var lo = hb;
        if(document.currentScript)lo = document.currentScript.src; else {
  
          var lq = document.getElementsByTagName(v);
          for(var i = 0;i < lq.length;i++)if(lq[i].src.search(gi) > 0 && lq[i].src.lastIndexOf(eG) >= 0){
        ...
        var lr = gc;
        var ln = new RegExp(lr);
        var lp = ln.exec(lo);
        if(lp != null && typeof window[lp[1]] == fN)window[lp[1]]();
      };
    }, 50);
  })();
  (function(){
    ...
    qx.Class.define(M, {
      ...
      members : {
        ...
        __dC : function(cq, cr, cs){
  
          if(cr == 0 && cs)this.setCustomProperty(cs.n, cs.v);
          cq(cr);
        },
        __fD : function(ct, cu, cv){
    ...
    qx.Class.define(h, {
      ...
      members : {
        ...
        setRequestsBaseUrl : function(){
          ...
          var I = H.isWhiteLabel();
          var K = I ? e : C;
          var J;
          if(typeof window === o || (window && window.__IS_NODEJS))J = wialon.core.NodeHttp; else J = wialon.core.PostMessage;
          this._req = {
          };
          this._req[u] = new J(this.createFullUrl(H.getBaseUrl()) + K + b, 0);
          if(H.getBaseGisUrl(p) != s)this._req[p] = new J(this.createFullUrl(H.getBaseGisUrl(p)) + l, 1); else this._req[p] = new J(this.createFullUrl() + v, 1);
          if(H.getBaseGisUrl(f) != s)this._req[f] = new J(this.createFullUrl(H.getBaseGisUrl(f)) + A, 1); else this._req[f] = new J(this.createFullUrl() + c, 1);
          if(H.getBaseGisUrl(D) != s)this._req[D] = new J(this.createFullUrl(H.getBaseGisUrl(D)) + j, 1); else this._req[D] = new J(this.createFullUrl() + r, 1);
        },
        remoteCall : function(N, Q, O, R){
  
          O = wialon.util.Helper.wrapCallback(O);
          if(typeof R == F)R = this.__dG;
          if(this.__dD)this.__dD.push({
            ...
            var P = wialon.core.Session.getInstance();
            var L = P.getApiPath() + B + N + k + P.getId();
            var M = {
              params : {
              }
            };
            ...
            return this.ajaxRequest(L, M, O, R, N);
          };
        },
        replaceSender : function(S, T){
  
          this._req[S] = T;
        },
        startBatch : function(U){
        ...
        finishBatch : function(V, bb, bc){
          ...
          this.__dE.push(V);
          if(this.__dF && bb != this.__dF){
  
            return;
          };
          V = wialon.util.Helper.wrapCallback(this.__dE);
          if(!this.__dD.length){
          ...
          this.remoteCall(a, {
            params : ba,
            flags : bc
          }, qx.lang.Function.bind(this.__dK, this, V, W), Y);
        },
        ajaxRequest : function(be, bh, bg, bi, bd){
  
          var bf = u;
          if(be.match(t))bf = f; else if(be.match(w))bf = p;;
          if(this._req[bf].supportAsync())this._req[bf].send(be, bh, qx.lang.Function.bind(this.__dH, this, bg), qx.lang.Function.bind(this.__dI, this, bg), bi, {
          }); else {
  
            bh.svc = bd;
            var bj = wialon.util.Json.stringify(bh);
            bh = null;
            return this.__dH(bg, wialon.util.Json.parse(this._req[bf].send(bj)));
          };
        },
        jsonRequest : function(bk, bo, bn, bp, bq){
  
          var bm = new qx.io.request.Jsonp(bk);
          var bl = null;
          bm.setCache(false);
          if(bq)bm.setCallbackName(bq);
          bm.setTimeout(bp * 1000);
          if(bo){
  
            if(typeof bo == G)bm.setRequestData(bo); else bm.setRequestData({
              params : bo
            });
          };
          if(bn){
  
            bm.addListener(n, qx.lang.Function.bind(this.__dJ, this, bn, bm));
            bl = qx.lang.Function.bind(this.__dI, this, bn, bm);
            bm.addListener(y, bl);
            bm.addListener(m, bl);
            bm.addListener(E, bl);
            bm.addListener(z, bl);
        ...
        createFullUrl : function(bt){
  
          if(typeof document == F)return bt;
          return bt ? bt : document.location.protocol + x + document.location.hostname + (document.location.port.length ? q + document.location.port : s);
        },
        __dH : function(bu, bv){
  
          return this.__dL(bv, bu);
        },
        __dI : function(bw, bx){
        ...
        __dJ : function(by, bz){
          ...
          this.__dL(bz.getResponse(), by);
        },
        __dK : function(bB, bD, bA, bC){
  
          if(bA == 0 && (!bC || !bD || bD.length != bC.length))bA = 3;
          if(bA){
  
            for(var i = 0;i < bD.length;i++)bD[i] ? bD[i](bA) : null;
            bB(bA, bA);
            return;
          };
          var bH = 0;
          ...
          for(var i = 0;i < bC.length;i++){
            ...
            bE.push(this.__dL(bC[i], bD[i]));
            if(bC[i])bH = bC[i];
            bG.push(bC[i]);
            if(typeof bC[i].error != F)bF++;
          };
          bB(bA, bH, bF, bG);
          return bE;
        },
        __dL : function(bJ, bI){
          ...
          if(bJ && typeof bJ.error != F && bJ.error != 0)return bI(bJ.error, bJ); else if(bJ)return bI(0, bJ); else return bI(3, null);;
        }
      },
      destruct : function(){
  
        if(this._req)for(var bL in this._req)if(this._req.hasOwnProperty(bL)){
  
          var bK = this._req[bL];
          if(bK && (typeof bK.dispose === d)){
    ...
    qx.Class.define(f, {
      ...
      members : {
        ...
        __fu : function(O){
          ...
          if(K[4])K.push(setTimeout(qx.lang.Function.bind(this.__dO, this, O), K[4] * 1000));
          var N = qx.lang.Function.bind(this.__dM, this, O, 0, d);
          var M = qx.lang.Function.bind(function(P, Q){
  
            Q.setEncoding(i);
            Q.on(b, qx.lang.Function.bind(this.__fv, this, P));
            Q.on(p, qx.lang.Function.bind(this.__dM, this, P));
          }, this, O);
        ...
        __dM : function(V){
          ...
          if(W.error && W.error == 1003 && U[3] < 3){
            ...
            if(U[4] && U[5]){
              ...
              clearTimeout(U[5]);
              U[5] = setTimeout(qx.lang.Function.bind(this.__dO, this, V), U[4] * 1000);
            };
    ...
    qx.Class.define(c, {
      ...
      members : {
        ...
        uploadFiles : function(I, bb, S, R, W, bc){
          ...
          var K = qx.lang.Function.bind(this.__eN, this, {
            callback : R,
            io : J,
            form : V,
            phase : 0
          ...
          if(!W){
            ...
            if(!this.__eK)this.__eK = M.addListener(k, this.__eO, this);
            this.__eL[L] = K;
          };
          V.setAttribute(q, X);
          V.submit();
          if(bc && W){
            ...
            var Y = qx.lang.Function.bind(function(){
              ...
              if(typeof this.__eL[L] == a)this.__eL[L]();
            }, this);
            setTimeout(Y, bc * 1000);
          };
          return true;
        },
        __eN : function(bd, event){
        ...
        __eO : function(event){
          ...
          var be = this.__eL[bf[G]];
          if(!be)return;
          be(bf);
          delete this.__eL[bf[G]];
        }
      }
    });
  })();
  ...
  (function(){
    ...
    var a = "download_file",b = "set",c = "cneh",d = "update_unit_phone",e = "changeAccessPassword",f = "update_unit_uid",g = "qx.event.type.Data",h = 'function',i = "check_config",j = "changeDeviceTypeId",k = "changeMessageParams",l = "changeDriverCode",m = "Float",n = "pos",o = "number",p = "unit/update_traffic_counter",q = "update_unit_trip_cfg",r = "update_alias",s = "unit/update_mileage_counter",t = "update_msgs_filter_cfg",u = "update_unit_milcounter",v = "delete_unit_msg",w = "unit/update_calc_flags",x = "bind_unit_trailer",y = "delete_alias",z = "?sid=",A = "unit/update_eh_counter",B = "&time=",C = "unit/set_active",D = "changeUniqueId2",E = "changeLastMessage",F = "unbind_unit_driver",G = "act",H = "hw",I = "update_unit_calcflags",J = "ud",K = "get",L = "&msgIndex=",M = "psw",N = "update_unit_phone2",O = "cfl",P = "uid2",Q = "avl_unit",R = "ph",S = "import_unit_msgs",T = "uid",U = "unit/exec_cmd",V = "update_unit_bytecounter",W = "create_alias",X = "lmsg",Y = "changePhoneNumber2",cs = "changeMileageCounter",ct = "changeActive",cu = "unit/reset_vrt_command_queue",co = "&svc=unit/update_hw_params&params=",cp = "unit/update_access_password",cq = "function",cr = "delete_service_interval",cz = "changeTrafficCounter",cA = "wialon.item.Unit",cB = "unit/get_vrt_command_queue",cC = "update_unit_report_cfg",cv = "Object",cw = "changeNetConn",cx = "unit/update_unique_id2",cy = "changePhoneNumber",cG = "/avl_msg_photo.jpeg?sid=",dg = "unit/update_activity_settings",dC = "update_unit_pass",cH = "cmds",cD = "ph2",cE = "changeUniqueId",dx = "changeCalcFlags",cF = "unbind_unit_trailer",cI = "unit/update_device_type",cJ = "unit/update_phone",cK = 'number',cO = "bind_unit_driver",cP = "update_unit_hw",cQ = "prms",cL = "account/change_account",cM = "object",dw = "changeEngineHoursCounter",cN = "unit/update_phone2",cU = "changeDeactivationTime",cV = "cnkb",dz = "update_unit_ehcounter",cW = "unit/get_activity_settings",cR = "update_sensor",cS = "Integer",dy = "changePosition",cT = "update_unit_fuel_cfg",db = "update_unit_uid2",dc = "Array",dB = 'position_validation',dd = "String",cX = "netconn",cY = "",dA = "update_service_interval",da = "cnm",de = "changeCommands",df = "v1311",dr = "create_sensor",dq = "drv",dp = "unit/get_command_definition_data",dv = "unit/update_hw_params",du = "update_unit_hw_config",dt = "delete_sensor",ds = "/adfurl",dk = "create_service_interval",dj = "import_unit_cfg",di = "dactt",dh = "&unitIndex=",dn = "delete_unit_msgs",dm = "create_unit",dl = "undefined";
    qx.Class.define(cA, {
      extend : wialon.item.Item,
      properties : {
        uniqueId : {
      ...
      members : {
        remoteCommand : function(dE, dD, dF, dI, dH, dG){
        ...
        remoteCommandDefinitions : function(dK, dJ){
        ...
        updateUniqueId2 : function(dQ, dR){
  
          return wialon.core.Remote.getInstance().remoteCall(cx, {
            itemId : this.getId(),
            uniqueId2 : dQ
          }, qx.lang.Function.bind(this._onUpdateProperties, this, wialon.util.Helper.wrapCallback(dR)));
        },
        updatePhoneNumber : function(dT, dS){
        ...
        updatePhoneNumber2 : function(dV, dU){
        ...
        updateAccessPassword : function(dX, dW){
        ...
        updateMileageCounter : function(ea, dY){
        ...
        updateEngineHoursCounter : function(ec, eb){
        ...
        updateTrafficCounter : function(ee, ef, ed){
        ...
        updateCalcFlags : function(eh, eg){
  
          return wialon.core.Remote.getInstance().remoteCall(w, {
            itemId : this.getId(),
            newValue : eh
          }, qx.lang.Function.bind(this._onUpdateProperties, this, wialon.util.Helper.wrapCallback(eg)));
        },
        updateActive : function(ej, ei){
        ...
        setActive : function(ek){
  
          this.updateActivity(ek);
        },
        getActive : function(){
  
          var el = this.getActivity();
          if(el === null)return 1; else return el;
        },
        changeAccount : function(en, em){
        ...
        handleMessage : function(es){
  
          if(es && es.tp == J){
  
            var er = this.getLastMessage();
            var eu = this.getPosition();
            var ep = es.f & wialon.item.Unit.dataMessageFlag.lbsFlag;
            var et = 0;
            if(eu)et = eu.f & wialon.item.Unit.dataMessageFlag.lbsFlag;
            if(!er || er.t < es.t){
  
              if(!er){
  
                this.setLastMessage(es);
                this.setPrevMessage(er);
              } else {
  
                var eq = qx.lang.Object.clone(es);
                if(es.p)eq.p = qx.lang.Object.clone(es.p);
                if(wialon.core.Session.getInstance().getVersion() == df){
  
                  qx.lang.Object.mergeWith(eq, er, 0);
                  if(er.p)qx.lang.Object.mergeWith(eq.p, er.p, 0);
                };
                if(eq.pos && (!eu || !ep || (eu.lc != es.lc && (et || (es.t - eu.t >= 300))))){
                } else {
  
                  if(eu){
  
                    eq.pos = qx.lang.Object.clone(eu);
                    eq.pos._noPosition = true;
                  } else {
  
                    eq.pos = null;
                  };
                };
                this.setLastMessage(eq);
                this.setPrevMessage(er);
              };
            };
            if(es.pos && (!eu || !eu.t || eu.t < es.t)){
  
              if(!eu || !ep || !eu.t || (eu.lc != es.lc && (et || (es.t - eu.t >= 300)))){
  
                var eo = qx.lang.Object.clone(es.pos);
                eo.t = es.t;
                eo.f = es.f;
                eo.lc = es.lc;
                wialon.item.Unit.__wI(this, eo);
                this.setPosition(eo);
              };
            };
          };
          wialon.item.Item.prototype.handleMessage.call(this, es);
        },
        getMessageImageUrl : function(ex, ev, ew){
  
          if(!ew)ew = cY;
          return wialon.core.Session.getInstance().getBaseUrl() + ds + ew + cG + wialon.core.Session.getInstance().getId() + B + ex + dh + this.getId() + L + ev;
        },
        downloadHwParamFile : function(eA, eB, ey){
  
          var ez = wialon.core.Session.getInstance();
          return ez.getBaseUrl() + ez.getApiPath() + z + ez.getId() + co + qx.lang.Json.stringify({
            itemId : this.getId(),
            hwId : eA,
            fileId : eB,
            action : a
        ...
        updateHwParams : function(eD, eE, eC, eF){
  
          if(eC && eC.length && (typeof eE.full_data != dl && !eE.full_data))wialon.core.Uploader.getInstance().uploadFiles(eC, dv, {
            itemId : this.getId(),
            hwId : eD,
            params_data : eE,
            action : b
          }, wialon.util.Helper.wrapCallback(eF), true, 30000); else return wialon.core.Remote.getInstance().remoteCall(dv, {
            itemId : this.getId(),
            hwId : eD,
            params_data : eE,
            action : b
          }, wialon.util.Helper.wrapCallback(eF));
        },
        getDriverActivitySettings : function(eG){
  
          return wialon.core.Remote.getInstance().remoteCall(cW, {
            itemId : this.getId()
          }, wialon.util.Helper.wrapCallback(eG));
        },
        updateDriverActivitySettings : function(eI, eH){
  
          return wialon.core.Remote.getInstance().remoteCall(dg, {
            itemId : this.getId(),
            type : eI
      ...
      statics : {
        ...
        logMessageAction : {
          unitCreated : dm,
          unitUpdatedPassword : dC,
          unitUpdatedPhone : d,
          unitUpdatedPhone2 : N,
          unitUpdatedCalcFlags : I,
          unitChangeMilageCounter : u,
          unitChangeByteCounter : V,
          unitChangeEngineHoursCounter : dz,
          unitUpdatedUniqueId : f,
          unitUpdatedUniqueId2 : db,
          unitUpdatedHwType : cP,
          unitUpdatedHwConfig : du,
          unitUpdatedFuelConsumptionSettings : cT,
          unitUpdatedTripDetectorSettings : q,
          unitCreatedSensor : dr,
          unitUpdatedSensor : cR,
          unitDeletedSensor : dt,
          unitCreatedCommandAlias : W,
          unitUpdatedCommandAlias : r,
          unitDeletedCommandAlias : y,
          unitCreatedServiceInterval : dk,
          unitUpdatedServiceInterval : dA,
          unitDeletedServiceInterval : cr,
          unitSettingsImported : dj,
          unitMessagesImported : S,
          unitMessageDeleted : v,
          unitMessagesDeleted : dn,
          unitDriverBinded : cO,
          unitDriverUnbinded : F,
          unitTrailerBinded : x,
          unitTrailerUnbinded : cF,
        ...
        registerProperties : function(){
          ...
          var eJ = wialon.core.Session.getInstance();
          eJ.registerConstructor(Q, wialon.item.Unit);
          eJ.registerProperty(T, this.remoteUpdateUniqueId);
          eJ.registerProperty(P, this.remoteUpdateUniqueId2);
          eJ.registerProperty(H, this.remoteUpdateDeviceTypeId);
          eJ.registerProperty(R, this.remoteUpdatePhoneNumber);
          eJ.registerProperty(cD, this.remoteUpdatePhoneNumber2);
          eJ.registerProperty(M, this.remoteUpdateAccessPassword);
          eJ.registerProperty(cH, this.remoteUpdateCommands);
          eJ.registerProperty(n, this.remoteUpdatePosition);
          eJ.registerProperty(X, this.remoteUpdateLastMessage);
          eJ.registerProperty(dq, this.remoteUpdateDriverCode);
          eJ.registerProperty(O, this.remoteUpdateCalcFlags);
          eJ.registerProperty(da, this.remoteUpdateMileageCounter);
          eJ.registerProperty(c, this.remoteUpdateEngineHoursCounter);
          eJ.registerProperty(cV, this.remoteUpdateTrafficCounter);
          eJ.registerProperty(cQ, this.remoteUpdateMessageParams);
          eJ.registerProperty(cX, this.remoteUpdateNetConn);
          eJ.registerProperty(G, this.remoteUpdateActive);
          eJ.registerProperty(di, this.remoteUpdateDeactivationTime);
          wialon.item.MIcon.registerIconProperties();
        },
        remoteUpdateUniqueId : function(eK, eL){
  
          eK.setUniqueId(eL);
        },
        remoteUpdateUniqueId2 : function(eM, eN){
  
          eM.setUniqueId2(eN);
        },
        remoteUpdateDeviceTypeId : function(eO, eP){
  
          eO.setDeviceTypeId(eP);
        },
        remoteUpdatePhoneNumber : function(eQ, eR){
  
          eQ.setPhoneNumber(eR);
        },
        remoteUpdatePhoneNumber2 : function(eS, eT){
  
          eS.setPhoneNumber2(eT);
        },
        remoteUpdateAccessPassword : function(eU, eV){
  
          eU.setAccessPassword(eV);
        },
        remoteUpdateCommands : function(eW, eX){
  
          eW.setCommands(eX);
        },
        remoteUpdatePosition : function(eY, fa){
  
          eY.setPosition(fa);
        },
        remoteUpdateLastMessage : function(fb, fc){
  
          fb.setLastMessage(fc);
        },
        remoteUpdateDriverCode : function(fd, fe){
  
          fd.setDriverCode(fe);
        },
        remoteUpdateCalcFlags : function(ff, fg){
  
          ff.setCalcFlags(fg);
        },
        remoteUpdateMileageCounter : function(fh, fi){
  
          fh.setMileageCounter(fi);
        },
        remoteUpdateEngineHoursCounter : function(fj, fk){
  
          fj.setEngineHoursCounter(fk);
        },
        remoteUpdateTrafficCounter : function(fl, fm){
  
          fl.setTrafficCounter(fm);
        },
        remoteUpdateMessageParams : function(fo, fq){
  
          if(typeof fq != cM)return;
          var fn = fo.getMessageParams();
          if(!fn)fn = {
          }; else fn = qx.lang.Object.clone(fn);
          for(var fp in fq){
  
            if(typeof fq[fp] == cM && typeof fn[fp] == cM && fq[fp].ct > fn[fp].ct){
  
              var fr = fn[fp].at;
              fn[fp] = fq[fp];
              if(fr > fq[fp].at)fn[fp].at = fr;
            } else if(typeof fq[fp] == cM && typeof fn[fp] == dl)fn[fp] = fq[fp]; else if(typeof fn[fp] == cM && typeof fq[fp] == o && fq[fp] > fn[fp].at)fn[fp].at = fq[fp];;;
          };
          fo.setMessageParams(fn);
        },
        remoteUpdateNetConn : function(fs, ft){
  
          fs.setNetConn(ft);
        },
        remoteUpdateActive : function(fu, fv){
  
          fu.setActivity(fv);
        },
        remoteUpdateDeactivationTime : function(fw, fx){
  
          fw.setDeactivationTime(fx);
        },
        checkHwConfig : function(fz, fy){
  
          return wialon.core.Remote.getInstance().remoteCall(dv, {
            hwId : fz,
            action : i
          }, wialon.util.Helper.wrapCallback(fy));
        },
        getHwParams : function(fD, fC, fB, fA){
          ...
          return wialon.core.Remote.getInstance().remoteCall(dv, {
            ...
            fullData : fB ? 1 : 0,
            action : K
          }, wialon.util.Helper.wrapCallback(fA));
        },
        __wI : function(fI, fH){
          ...
          var fF = fG.getLogger();
          if(!fF || (typeof fF.warn !== h))return;
          var fE = (typeof fH.x === cK) && (typeof fH.y === cK);
          if(!fE)return;
          fE = (-90 <= fH.y && fH.y <= 90);
          if(!fE){
    ...
    qx.Class.define(e, {
      ...
      members : {
        ...
        getTileUrl : function(x, y, z){
          ...
          return wialon.core.Session.getInstance().getBaseUrl() + v + this.__wC + s + this.getVersion() + C + x + s + y + s + (17 - z) + n + wialon.core.Session.getInstance().getId() + c;
        },
  ...
  (function(){
    ...
    var a = "messages/get_packed_messages",b = "messages/delete_message",c = "messages/load_interval",d = "&svc=messages/get_message_file&params=",e = "wialon.core.MessagesLoader",f = "messages/load_last",g = "messages/unload",h = "messages/get_messages",i = "?sid=";
    qx.Class.define(e, {
      extend : qx.core.Object,
      members : {
        ...
        getMessageFile : function(C, D){
  
          var B = wialon.core.Session.getInstance();
          return B.getBaseUrl() + B.getApiPath() + i + B.getId() + d + encodeURIComponent(wialon.util.Json.stringify({
            msgIndex : C,
            fileName : D
          }));
        },
        deleteMessage : function(F, E){
  
          return wialon.core.Remote.getInstance().remoteCall(b, {
            msgIndex : F
          }, wialon.util.Helper.wrapCallback(E));
        },
        getPackedMessages : function(G, I, K, J, H){
  ...
  (function(){
    ...
    var a = "function",b = 'Sensors',c = "create",d = "set",f = ';',g = '',h = 'object',j = "delete",k = "remoteCreate",l = "string",m = "static",n = "qx.event.type.Data",o = 'monitoring_sensor',p = 'function',q = "reset_image",r = "Driver",s = "get",t = "modify",u = "number",v = "Object",w = "ProfileField",x = "Poi",y = "u",z = "wialon.item.PluginsManager",A = "s",B = "Tag",C = "Data",D = "update",E = "wialon.item.M",F = "remoteUpdate",G = 'monitoring_sensor_id',H = "Zone",I = "Trailer",J = "resetImage",K = 'string',L = "mixinDef = wialon.item.M",M = "undefined",N = "object";
    qx.Class.define(z, {
      type : m,
      statics : {
        bindPropItem : function(clazz, propName, itemName, ajaxPath, extAjaxPath){
          ...
          mixinBody.events[D + itemNameUCase] = n;
          mixinBody.properties[itemName + A] = {
            init : null,
            check : v
          };
          mixinBody.members[s + itemNameUCase] = function(Q){
  
            var P = this[s + multName]();
            if(!P)return null;
            var O = P[Q];
            if(typeof O == M)return null;
            return O;
          };
          mixinBody.members[t + multName] = function(V, R, X){
  
            var S = this[s + multName]();
            var T = false;
            if(V && typeof V == N){
  
              T = V.skipFlag;
              V = wialon.util.Helper.wrapCallback(V.callback);
            } else {
  
              V = wialon.util.Helper.wrapCallback(V);
            };
            var W = null;
            if(R == 0 && S && X instanceof Array && X.length == 2){
  
              var ba = X[0];
              W = X[1];
              var Y = S[ba];
              var U = getMonitoringSensorColorTable(this);
              if(W && U && U.sensorId === parseInt(ba, 10)){
  
                fixSensorColorTable(W, U.ci);
              };
              if(typeof Y == M)Y = null;
              if(W != null)S[ba] = W; else if(Y && !T)delete S[ba];;
              if(!T && wialon.util.Json.stringify(W) != wialon.util.Json.stringify(Y))this.fireDataEvent(D + itemNameUCase, W, Y);
            };
            V(R, W, {
              result : X
            });
          ...
          if(ajaxPath && ajaxPath.length){
            ...
            if(itemNameUCase == w){
              ...
              mixinBody.members[D + itemNameUCase] = function(name, bc, bb){
                ...
                return wialon.core.Remote.getInstance().remoteCall(ajaxPath, {
                  ...
                  n : name,
                  v : bc
                }, qx.lang.Function.bind(this[t + multName], this, bb));
              };
            } else {
  
              mixinBody.members[c + itemNameUCase] = function(bf, bd, be){
  
                bd = wialon.util.Helper.wrapCallback(bd);
                if(bf){
  
                  bf = qx.lang.Object.clone(bf);
                  bf.itemId = this.getId();
                  bf.id = 0;
                  bf.callMode = c;
                };
                if(be)wialon.core.Uploader.getInstance().uploadFiles([be], ajaxPath, bf, qx.lang.Function.bind(this[t + multName], this, bd), true, 60); else return wialon.core.Remote.getInstance().remoteCall(ajaxPath, bf, qx.lang.Function.bind(this[t + multName], this, bd));
              };
              mixinBody.members[D + itemNameUCase] = function(bj, bh, bg, bi){
  
                bh = wialon.util.Helper.wrapCallback(bh);
                if(bj){
  
                  bj = qx.lang.Object.clone(bj);
                  bj.itemId = this.getId();
                  bj.callMode = typeof bg == l ? bg : D;
                };
                if(bi)wialon.core.Uploader.getInstance().uploadFiles([bi], ajaxPath, bj, qx.lang.Function.bind(this[t + multName], this, bh), true, 60); else return wialon.core.Remote.getInstance().remoteCall(ajaxPath, bj, qx.lang.Function.bind(this[t + multName], this, bh));
              };
              mixinBody.members[j + itemNameUCase] = function(bm, bk, bl){
  
                if(typeof bl == M)bl = false;
                bk = wialon.util.Helper.wrapCallback(bk);
                return wialon.core.Remote.getInstance().remoteCall(ajaxPath, {
                  itemId : this.getId(),
                  id : bm,
                  callMode : j
              ...
              if(itemNameUCase == r || itemNameUCase == I || itemNameUCase == x || itemNameUCase == H || itemNameUCase == B){
  
                mixinBody.members[J + itemNameUCase] = function(bp, bn, bo){
  
                  if(typeof bo == M)bo = false;
          ...
          if(extAjaxPath && extAjaxPath.length){
            ...
            mixinBody.members[s + multName + C] = function(bs, br, bq){
              ...
              if(bs && (typeof bs.length === u)){
  
                bt.col = [];
                for(var i = 0;i < bs.length;i++){
  
                  if(typeof bs[i].id == M)bt.col.push(bs[i]); else bt.col.push(bs[i].id);
                };
              };
              bt.flags = br;
              return wialon.core.Remote.getInstance().remoteCall(extAjaxPath, bt, bq);
            };
          };
          mixinBody.statics[k + itemNameUCase] = function(bu, bw){
  
            var bx = getMonitoringSensorColorTable(bu);
            if(bx && bw && bw[bx.sensorId]){
  
              var bv = bw[bx.sensorId];
              fixSensorColorTable(bv, bx.ci);
            };
            bu[d + multName](bw);
          };
          mixinBody.statics[F + itemNameUCase] = function(by, bz){
  
            by[t + multName](null, 0, bz);
          };
          var session = wialon.core.Session.getInstance();
          session.registerProperty(propName, qx.lang.Function.bind(mixinBody.statics[k + itemNameUCase], mixinBody));
          session.registerProperty(propName + y, qx.lang.Function.bind(mixinBody.statics[F + itemNameUCase], mixinBody));
          var mixinDef = null;
          eval(L + multName);
          if(qx.Class.hasMixin(clazz, mixinDef))return;
          var propMixin = qx.Mixin.define(E + multName, mixinBody);
          qx.Class.include(clazz, propMixin);
          function getMonitoringSensorColorTable(bD){
  
            if(multName !== b)return null;
            if(!bD || (typeof bD.getType !== p) || (typeof bD.getCustomProperty !== p))return null;
            var bF = parseInt(bD.getCustomProperty(G), 10);
            if(!bF || !isFinite(bF))return null;
            var bE = bD.getCustomProperty(o);
            if(!bE || (typeof bE !== K))return null;
            var bA = bE.split(f);
            var bC = {
            };
            var bG = true;
            var bB = bA.every(function(bL){
  
              var bJ = /^(\d+(?:\.\d+)?|-?Infinity)\s+([0-9a-fA-F]{6,8})(?:\s+(.*?))?\s*$/.exec(bL);
              if(!bJ)return false;
              var bK = parseFloat(bJ[1]);
              if(isNaN(bK))return false;
              var bH = bJ[2];
              if(bH.length === 6){
                ...
                bH = parseInt(bH.slice(2), 16);
              };
              if(!isFinite(bH))return false;
              var bI = bJ[3] || g;
              bC[bK] = {
                c : bH,
                t : bI
          ...
          function fixSensorColorTable(bN, bO){
            ...
            if(!bM.ci || bP(bM.ci)){
              ...
              bM.ci = bO;
              bN.c = JSON.stringify(bM);
            };
            function bP(bQ){
  
              for(var bR in bQ)if(Object.prototype.hasOwnProperty.call(bQ, bR)){
  ...
  (function(){
    ...
    var a = "const0",b = "regtime",c = "sats",d = "lon",f = '_',g = "speed",h = "string",j = "-0123456789",k = '',l = '^',m = "d",n = ']',o = "-0123456789ABCDEFabcdefx",p = "altitude",q = '(',r = ":",s = ':',t = '*',u = '.',v = "time",w = "lat",x = '|',y = "",z = "number",A = ')',B = "n",C = "const",D = "wialon.item.MUnitSensor",E = ' ',F = "unit/calc_last_message",G = "course",H = '#',I = '/',J = '-',K = "unit/calc_sensors",L = '[',M = "-01234567",N = "undefined",O = '+';
    qx.Mixin.define(D, {
      members : {
        calculateSensorValue : function(P, Q, R){
  
          if(!P)return wialon.item.MUnitSensor.invalidValue;
          if(typeof Q == N || !Q)Q = null;
          if(typeof R == N || !R)R = null;
          return this.__eX(P, Q, R, null);
        },
        remoteCalculateLastMessage : function(T, S){
  
          if(!T || !(T instanceof Array))T = [];
          return wialon.core.Remote.getInstance().remoteCall(F, {
            sensors : T,
            unitId : this.getId()
          }, wialon.util.Helper.wrapCallback(S));
        },
        remoteCalculateMsgs : function(Y, X, U, W, V){
        ...
        remoteCalculateFilteredMsgs : function(bc, bb, ba, be, bf, bd){
        ...
        getValue : function(bg, bh){
  
          if(!bg)return wialon.item.MUnitSensor.invalidValue;
          return this.__eY(bg.p, bh, bg);
        },
        __eW : {
        },
        __eX : function(bo, bp, bi, bn){
  
          if(!bo)return wialon.item.MUnitSensor.invalidValue;
          var bk = false;
          var bm = bo.id;
          if(bn){
  
            if(bn[bm])return wialon.item.MUnitSensor.invalidValue;
          } else {
          ...
          bn[bm] = 1;
          var bj = this.__fb(bo, bp, bi, bn);
          if(typeof (bj) == h)return bj;
          if(bj != wialon.item.MUnitSensor.invalidValue)bj = this.__fa(bo, bj);
          if(bo.vs && bo.vt){
  
            var bl = this.getSensor(bo.vs);
            if(!bl){
  
              delete bn[bm];
              return wialon.item.MUnitSensor.invalidValue;
            };
            var bq = this.__eX(bl, bp, bi, bn);
            if(bj != wialon.item.MUnitSensor.invalidValue && bq != wialon.item.MUnitSensor.invalidValue){
  
              if(bo.vt == wialon.item.MUnitSensor.validation.logicalAnd){
  
                if(bj && bq)bj = 1; else bj = 0;
              } else if(bo.vt == wialon.item.MUnitSensor.validation.noneZero){
              ...
              } else if(bo.vt == wialon.item.MUnitSensor.validation.mathAnd){
  
                bj = Math.ceil(bq) & Math.ceil(bj);
              } else if(bo.vt == wialon.item.MUnitSensor.validation.logicalOr){
  
                if(bj || bq)bj = 1;
              } else if(bo.vt == wialon.item.MUnitSensor.validation.mathOr){
  
                bj = Math.ceil(bq) | Math.ceil(bj);
              } else if(bo.vt == wialon.item.MUnitSensor.validation.summarize)bj += bq; else if(bo.vt == wialon.item.MUnitSensor.validation.subtructValidator)bj -= bq; else if(bo.vt == wialon.item.MUnitSensor.validation.subtructValue)bj = bq - bj; else if(bo.vt == wialon.item.MUnitSensor.validation.multiply)bj *= bq; else if(bo.vt == wialon.item.MUnitSensor.validation.divideValidator){
  
                if(bq)bj /= bq; else bj = wialon.item.MUnitSensor.invalidValue;
              } else if(bo.vt == wialon.item.MUnitSensor.validation.divideValue){
  
                if(bj)bj = bq / bj; else bj = wialon.item.MUnitSensor.invalidValue;
              };;;;;;;;;;
            } else if(bo.vt == wialon.item.MUnitSensor.validation.replaceOnError){
  
              if(bj == wialon.item.MUnitSensor.invalidValue)bj = bq;
            } else bj = wialon.item.MUnitSensor.invalidValue;;
          };
          delete bn[bm];
          return bj;
        },
        __eY : function(by, bG, bw){
          ...
          if(bA && typeof bA[bs[0]] != N){
            ...
            if(typeof bv == h){
              ...
              if(typeof bs[1] != N){
                ...
                if(bs[1] == 8)bB = M; else if(bs[1] == 16)bB = o;;
                if(wialon.util.String.strspn(bv, bB) == bv.length){
  
                  bv = parseInt(bv, bs[1]);
                  bs = [];
                } else bv = wialon.item.MUnitSensor.invalidValue;
              };
            };
          } else if(bs[1] == m){
          ...
          var bz = bG.pos;
          if(bv == wialon.item.MUnitSensor.invalidValue){
  
            if(by == g){
  
              if(!bz || (bz && bz._noPosition))return wialon.item.MUnitSensor.invalidValue;
              bv = bG.pos.s;
            } else if(by == c){
              ...
              if(!bz || (bz && bz._noPosition))return wialon.item.MUnitSensor.invalidValue;
              bv = bG.pos.x;
            } else if(/^in\d{0,2}$/.test(by)){
  
              if(!(bG.f & 0x2))return wialon.item.MUnitSensor.invalidValue;
              var bt = parseInt(by.substr(2), 10);
              if(isNaN(bt) || bt < 1 || bt > 32)return bG.i;
              var bE = 1 << (bt - 1);
              bv = (bG.i & bE) ? 1 : 0;
            } else if(/^out\d{0,2}$/.test(by)){
  
              if(!(bG.f & 0x4))return wialon.item.MUnitSensor.invalidValue;
              var bt = parseInt(by.substr(3), 10);
              if(isNaN(bt) || bt < 1 || bt > 32)return bG.o;
              var bE = 1 << (bt - 1);
              bv = (bG.o & bE) ? 1 : 0;
            } else if(/^const-?(?:\d+(?:\.\d+)?|\.\d+)$/.test(by)){
  
              bv = parseFloat(by.substr(5));
            } else if(by === v){
          ...
          if(bx == 1 && bv != wialon.item.MUnitSensor.invalidValue){
  
            var bF = new Date(bv * 1000);
            var bu = Date.UTC(bF.getFullYear(), 0, 0);
            var bD = bF.getTime() - bu;
            var br = 1000 * 60 * 60 * 24;
            bv = Math.floor(bD / br);
          } else if(bs.length > 1 && bv != wialon.item.MUnitSensor.invalidValue){
  
            var bH = parseInt(bv, 10);
            var bC = parseInt(bs[1], 10) - 1;
            if(bC < 32){
  
              bv = bH & (1 << bC);
            } else {
  
              bv = wialon.util.Number.and(bH, Math.pow(2, bC));
            };
            bv = bv ? 1 : 0;
          };
          return bv;
        ...
        __fa : function(bN, bK){
          ...
          if(!bN || isNaN(bK))return wialon.item.MUnitSensor.invalidValue;
          var bL = wialon.item.MUnitSensor.invalidValue;
          var bJ = wialon.item.MUnitSensor.invalidValue;
          var bM = null;
          try{
  
            bM = wialon.util.Json.parse(bN.c);
          } catch(e) {
          };
          if(bM && typeof bM.lower_bound == z)bL = bM.lower_bound;
          if(bM && typeof bM.upper_bound == z)bJ = bM.upper_bound;
          if(bL != wialon.item.MUnitSensor.invalidValue && bJ != wialon.item.MUnitSensor.invalidValue && bJ <= bL){
  
            bL = wialon.item.MUnitSensor.invalidValue;
            bJ = wialon.item.MUnitSensor.invalidValue;
          };
          if(!(bN.f & wialon.item.MUnitSensor.flags.boundsAfterCalc) && ((bL != wialon.item.MUnitSensor.invalidValue && bK < bL) || (bJ != wialon.item.MUnitSensor.invalidValue && bK >= bJ)))return wialon.item.MUnitSensor.invalidValue;
          var bI = bK;
          for(var i = 0;i < bN.tbl.length;i++){
  
            if(i != 0 && bN.tbl[i].x > bK)break;
            bI = parseFloat(bN.tbl[i].a) * parseFloat(bK) + parseFloat(bN.tbl[i].b);
          };
          if((bN.f & wialon.item.MUnitSensor.flags.boundsAfterCalc) && ((bL != wialon.item.MUnitSensor.invalidValue && bI < bL) || (bJ != wialon.item.MUnitSensor.invalidValue && bI >= bJ)))return wialon.item.MUnitSensor.invalidValue;
          return bI;
        },
        __fb : function(bT, bV, bR, bS){
  
          if(!bT || typeof bT.p != h || !bT.p.length)return wialon.item.MUnitSensor.invalidValue;
          var bQ = this.__eW[bT.p];
          if(typeof bQ == N){
  
            bQ = this.__fc(bT.p);
            if(!bQ.length)return wialon.item.MUnitSensor.invalidValue;
            this.__eW[bT.p] = bQ;
          };
          var bU = [];
          var bO = 0;
          for(var i = 0;i < bQ.length;i++){
            ...
            if(bP[0] == t && bW > 1){
              ...
              if((wialon.item.MUnitSensor.invalidValue == bU[bW - 2]) || (wialon.item.MUnitSensor.invalidValue == bU[bW - 1]))bU[bW - 2] = wialon.item.MUnitSensor.invalidValue; else bU[bW - 2] = bU[bW - 2] * bU[bW - 1];
              bU.pop();
            } else if(bP[0] == I && bW > 1){
  
              if((wialon.item.MUnitSensor.invalidValue == bU[bW - 2]) || (wialon.item.MUnitSensor.invalidValue == bU[bW - 1]) || (bU[bW - 1] == 0))bU[bW - 2] = wialon.item.MUnitSensor.invalidValue; else bU[bW - 2] = bU[bW - 2] / bU[bW - 1];
              bU.pop();
            } else if(bP[0] == O && bW > 1){
              ...
              if(bW > 1){
                ...
                if((wialon.item.MUnitSensor.invalidValue == bU[bW - 2]) || (wialon.item.MUnitSensor.invalidValue == bU[bW - 1]))bU[bW - 2] = wialon.item.MUnitSensor.invalidValue; else bU[bW - 2] = bU[bW - 2] - bU[bW - 1];
                bU.pop();
              } else if(bW == 1)bU[bW - 1] = -bU[bW - 1];;
            } else if(bP[0] == l && bW > 1){
  
              if((wialon.item.MUnitSensor.invalidValue == bU[bW - 2]) || (wialon.item.MUnitSensor.invalidValue == bU[bW - 1]))bU[bW - 2] = wialon.item.MUnitSensor.invalidValue; else bU[bW - 2] = Math.pow(bU[bW - 2], bU[bW - 1]);
              bU.pop();
            } else if(bP[0] == x && bW > 1){
  
              if(wialon.item.MUnitSensor.invalidValue == bU[bW - 2])bU[bW - 2] = bU[bW - 1];
              bU.pop();
            } else {
  
              if(bP[0] == L){
  
                var bT = wialon.util.Helper.searchObject(this.getSensors(), B, bP.slice(1));
                if(!bT){
  
                  bU.push(wialon.item.MUnitSensor.invalidValue);
                  continue;
                };
                bO = this.__eX(bT, bV, bR, bS);
                bU.push(bO);
              } else {
  
                bO = wialon.item.MUnitSensor.invalidValue;
                if(bP[0] == H)bO = this.__eY(bP.slice(1), bR, bT); else bO = this.__eY(bP, bV, bT);
                if(typeof (bO) == h)return bO;
                bU.push(bO);
              };
            };;;;;
          };
          return bU.length == 1 ? bU[0] : wialon.item.MUnitSensor.invalidValue;
        },
        __fc : function(cg){
          ...
          for(var i = 0;i < cc;i++){
            ...
            if(cg[i] == E){
              ...
              if(!ck)continue;
            } else if(cg[i] == L)cf = true; else if(cg[i] == n)cf = false;;;
            var ci = cg[i].charCodeAt(0);
            var cb = (ci > 47 && ci < 58) || (ci > 64 && ci < 91) || (ci > 96 && ci < 123);
            var bX = cf || cb || cg[i] === f || cg[i] === H || cg[i] === u || cg[i] === s || cg[i] === E || (cg[i] === J && cj === C);
            if(bX){
            ...
            if(ca != -1){
              ...
              if(cg[i] == J && cl)cd.push(a);
              if(cg[i] == q)cl = true; else cl = false;
              if(ch.length){
  
                if(cg[i] == q)ch.push(cj); else if(cg[i] == A){
  
                  while(ch.length){
  
                    var ce = ch[ch.length - 1];
                    ch.pop();
                    if(ce[0] != q)cd.push(ce); else break;
                  };
                } else {
                  ...
                  while(ch.length){
                    ...
                    if(bY >= ca){
                      ...
                      if(ce[0] != q && ce[0] != A)cd.push(ch[ch.length - 1]);
                      ch.pop();
                    } else break;
                  };
                  ch.push(cj);
          ...
          while(ch.length){
            ...
            var ce = ch[ch.length - 1];
            if(ce[0] != A && ce[0] != q)cd.push(ce);
            ch.pop();
          };
          if(!cd.length)cd.push(cg);
          return cd;
        },
        __fd : function(cm){
          ...
          switch(cm[0]){case x:
          return 5;case l:
          return 4;case t:case I:
          return 3;case J:case O:
          return 2;case A:
          return 1;case q:
          return 0;};
          return -1;
  ...
  (function(){
    ...
    qx.Class.define(e, {
      ...
      members : {
        ...
        getChartUrl : function(O, T, M, P, S, Q, V, N){
          ...
          var R = wialon.core.Session.getInstance();
          return R.getBaseUrl() + R.getApiPath() + l + R.getId() + i + encodeURIComponent(wialon.util.Json.stringify(U));
        },
        hitTestChart : function(X, W){
          ...
          if(X && typeof X == k){
            ...
            Y.attachmentIndex = arguments[0];
            Y.datasetIndex = arguments[1];
            Y.valueX = arguments[2];
            if(arguments.length > 4){
  
              Y.valueY = arguments[3];
              Y.flags = arguments[4];
            } else {
          ...
          return wialon.core.Remote.getInstance().remoteCall(h, {
            attachmentIndex : Y.attachmentIndex,
        ...
        getExportUrl : function(bd, bc){
  
          var bb = qx.lang.Object.clone(bc);
          bb.format = bd;
          var ba = wialon.core.Session.getInstance();
          return ba.getBaseUrl() + ba.getApiPath() + l + ba.getId() + b + encodeURIComponent(wialon.util.Json.stringify(bb));
        },
        getMapUrl : function(be, bh){
          ...
          var bf = wialon.core.Session.getInstance();
          return bf.getBaseUrl() + bf.getApiPath() + l + bf.getId() + f + encodeURIComponent(wialon.util.Json.stringify(bg));
        },
        getPhotoUrl : function(bl, bi){
          ...
          var bj = wialon.core.Session.getInstance();
          return bj.getBaseUrl() + bj.getApiPath() + l + bj.getId() + c + encodeURIComponent(wialon.util.Json.stringify(bk));
        },
        getVideoUrl : function(bo, bm){
  
          var bn = {
            attachmentIndex : bo,
            rnd : (new Date).getTime()
          };
          return wialon.core.Remote.getInstance().remoteCall(m, bn, wialon.util.Helper.wrapCallback(bm));
        },
      ...
      members : {
        ...
        __fo : function(bC, bA){
          ...
          for(var i = 0;i < bD.length;i++){
            ...
            var bF = bD[i];
            if(!this.__fk[bF])this.__fk[bF] = {
            };
            if(!this.__fk[bF][bC.owner])this.__fk[bF][bC.owner] = 0;
            this.__fk[bF][bC.owner] = wialon.util.Number.or(this.__fk[bF][bC.owner], bC.spec.flags);
          };
    ...
    qx.Class.define(d, {
      ...
      statics : {
        ...
        putFiles : function(A, F, B, E, G, C){
          ...
          D.path = F;
          D.flags = G;
          wialon.core.Uploader.getInstance().uploadFiles(B, g, D, qx.lang.Function.bind(this.__eN, this, C), 1, E);
        },
        ...
        __eN : function(Q, R, S){
          ...
          if(S && this.__fp(S, l) && this.__fp(S, i))Q(S.error, S.files); else Q(0, e);
        },
        __fp : function(U, V){
